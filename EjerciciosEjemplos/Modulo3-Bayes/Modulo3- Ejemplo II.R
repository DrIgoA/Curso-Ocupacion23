...
# Diametro promedio de 谩rboles en un parque de bosque de eucalipto
...
# La presici贸n que es la que se usa, es de 0.04 (1/varianza)
...
# Di醡etro promedio de 胷boles en un parque de bosque de eucalipto
...
## Estimaci贸n de media con Poisson~~~~~~~~~~~~~~####

# Investigadores en NY midieron la densidad de arboles en 10 cuadrantes (400m2 c/U)
# en Van Cortlandt Park

# Una distribuci贸n previa no informativa para la densidad media del red oak en cda cuadrante
# debe tomar valores positivos y tener una amplia distribucion.

#Una distribuci贸n lonormal que tenga media 0 y desvio standar 1000 para valores 
