...
save(out_general, file = "out_general")
load("~/Documentos/TRABAJO/Curso Ocupacion Mendoza/out_general")
...
##### GLM randon odernada por especie ####
...
load("~/Documentos/TRABAJO/Curso Ocupacion Mendoza/out_dos_fijas")
...
load("~/Documentos/TRABAJO/Curso Ocupacion Mendoza/out_random_hiper")
